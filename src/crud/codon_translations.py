...
class CodonTranslationRepository(BaseRepository):
    def list(self, codon_table_name: str) -> sa.Sequence[CodonTranslation]:
    ...
    def get(self, codon_table_name: str, codon: str) -> CodonTranslation | None:
        stmt = sa.select(CodonTranslation).where(
            CodonTranslation.codon_table_name == codon_table_name,
    ...
    def update(self, codon_table_name: str, codon: str, data: dict) -> None:
        stmt = (
    ...
    def delete(self, codon_table_name: str, codon: str) -> None:
