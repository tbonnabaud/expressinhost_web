...
Revision ID: e4b9df73da30
Revises: 
Create Date: 2024-10-31 16:52:28.662956
...
def upgrade() -> None:
    ...
    sa.Column('codon_table_name', sa.String(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('codon_table_name', 'codon', name='pk_codon_translations')
    )
    ...
    sa.Column('user_id', sa.UUID(), nullable=True),
    sa.Column('creation_date', sa.DateTime(), nullable=False),
    sa.Column('host_codon_table_name', sa.String(), nullable=False),
